            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index-2.html" class="logo"><i class="mdi mdi-radar"></i> <span>Minton</span></a>
                    </div>
                </div>
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="badge badge-pink noti-icon-badge">{{auth()->user()->unReadNotifications()->count()}}</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg" aria-labelledby="Preview">
                                <!-- item-->
                                <div class="dropdown-item noti-title">
                                    <h5 class="font-16"><span class="badge badge-danger float-right">{{auth()->user()->unreadNotifications()->count()}}</span>Notification</h5>
                                </div>
                                @foreach(auth()->user()->unreadNotifications as $notification)
                                <!-- item-->
                                <a href="/notifications/{{$notification->id}}/read" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-success"><i class="mdi mdi-comment-account"></i></div>
                                    <p class="notify-details">{{$notification->data["details"]??""}}<small class="text-muted">{{$notification->created_at->diffForHumans()}}</small></p>
                                </a>
                                @endforeach
                                <!-- All-->
